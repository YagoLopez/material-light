...
var PagTextfiel2dMod = (function () {
    function PagTextfiel2dMod() {
    }
    PagTextfiel2dMod = __decorate([
        core_1.NgModule({
            imports: [mlIconMod_1.MlIconMod, mlValidationErrorMod_1.MlValidationErrorMod, mlButtonMod_1.MlButtonMod, debugFormMod_1.DebugFormMod, forms_1.FormsModule, forms_1.ReactiveFormsModule, mlTextfieldMod_1.MlTextfieldMod,
                viewSourceMod_1.ViewSourceMod, router_1.RouterModule.forChild([{ path: '', component: pagTextfield2_1.PagTextfield2 }])],
            declarations: [pagTextfield2_1.PagTextfield2] }), 
        __metadata('design:paramtypes', [])
    ], PagTextfiel2dMod);
    return PagTextfiel2dMod;
}());
exports.PagTextfiel2dMod = PagTextfiel2dMod;
