    ...
    MlLayoutMod = __decorate([
        core_1.NgModule({
            ...
            declarations: [mlLayout_1.MlLayout, mlLayout_1.MlHeader, mlLayout_1.MlHeaderRow, mlLayout_1.MlDrawer, mlLayout_1.MlSpacer, mlLayout_1.MlNav, mlLayout_1.MlNavItem, mlLayout_1.MlLargeScreenOnly,
                mlLayout_1.MlSmallScreenOnly, mlLayout_1.MlContent, mlLayout_1.MlHeaderTabs, mlLayout_1.MlHeaderTabBar, mlLayout_1.MlHeaderTabContent, mlLayout_1.MlHeaderTabActive
            ],
            exports: [mlLayout_1.MlLayout, mlLayout_1.MlHeader, mlLayout_1.MlHeaderRow, mlLayout_1.MlDrawer, mlLayout_1.MlSpacer, mlLayout_1.MlNav, mlLayout_1.MlNavItem, mlLayout_1.MlLargeScreenOnly,
                mlLayout_1.MlSmallScreenOnly, mlLayout_1.MlContent, mlLayout_1.MlHeaderTabs, mlLayout_1.MlHeaderTabBar, mlLayout_1.MlHeaderTabContent, mlLayout_1.MlHeaderTabActive]
        }), 
