...
/**
   ...
   */
MdlSlider.prototype.onInput_ = function (event) {
...
/**
   ...
   * @param {Event} event The event that fired.
   */
MdlSlider.prototype.onChange_ = function (event) {
    this.updateValueStyles_();
};
/**
   ...
   * @param {Event} event The event that fired.
   */
MdlSlider.prototype.onMouseUp_ = function (event) {
    event.target.blur();
};
/**
...
/**
   ...
   */
MdlSlider.prototype.change = function (value) {
...
//# sourceMappingURL=C:/Users/Yago/WebstormProjects/material-light-demo-webpack/src/app/ml/components/controls/slider/mdl_slider.js.map