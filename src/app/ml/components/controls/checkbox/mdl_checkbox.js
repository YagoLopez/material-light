...
var MdlCheckbox = (function (_super) {
    __extends(MdlCheckbox, _super);
    function MdlCheckbox(el) {
        _super.call(this, el);
    }
    return MdlCheckbox;
 ...
 */
MdlCheckbox.prototype.onChange_ = function (event) {
    this.updateClasses_();
};
/**
 ...
 * @param {Event} event The event that fired.
 */
MdlCheckbox.prototype.onFocus_ = function (event) {
 ...
 * @param {Event} event The event that fired.
 */
MdlCheckbox.prototype.onBlur_ = function (event) {
 ...
 * @param {Event} event The event that fired.
 */
MdlCheckbox.prototype.onMouseUp_ = function (event) {
    this.blur_();
};
...
//# sourceMappingURL=mdl_checkbox.js.map